export type WidgetId = 'social-follow' | 'social-rotator' | 'tipjar'

const WIDGETS = [
  { id: 'tipjar' as const, name: 'Pixel Tipjar', desc: 'Toples pixel-art terisi koin setiap hadiah masuk lewat Tako' },
