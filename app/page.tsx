    ...
    <div className="min-h-screen bg-studio-950 flex flex-col items-center justify-center p-8">
      <div className="max-w-2xl w-full">
        <div className="text-center mb-12">
          ...
          <h1 className="text-white font-display text-4xl md:text-5xl font-bold tracking-tight">Glass Tipjar</h1>
          <p className="text-zinc-500 mt-3 text-sm max-w-md mx-auto">Toples kaca realistis — liquid fill, shine, & wave animation.</p>
        </div>
          ...
          <button onClick={() => router.push('/glass')} className="group w-full text-left p-5 rounded-2xl border border-studio-border bg-studio-900 hover:bg-studio-800 hover:border-white/10 transition-all duration-200">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-white font-display font-semibold text-base">Open Customizer</h3>
                <p className="text-zinc-500 text-sm mt-0.5">Customize &amp; get widget URL</p>
              </div>
