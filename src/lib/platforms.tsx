...
export const toHex7 = (c: string) => /^#[0-9a-fA-F]{6}$/.test(c) ? c : '#000000'

export function SectionTitle({ children }: { children: React.ReactNode }) {
  return <h3 className="text-zinc-300 text-xs font-semibold uppercase tracking-wider mb-3">{children}</h3>
}
